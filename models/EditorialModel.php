...
class EditorialModel
{
	...
	public static function BuscarEditorialByQuery($query){
		$sql = "SELECT * FROM editorial WHERE Nombre LIKE '%$query%' OR ID LIKE '%$query%' ORDER BY ID asc LIMIT 10";
		$result = EditorialModel::Get_Data($sql);
  		return $result;
	}
}
?>